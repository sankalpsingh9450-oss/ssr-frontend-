    ...
    <>
      <section className="page-hero">
        <div className="container page-hero-content">
          ...
          <p>Building excellence through transparency, quality, and unwavering commitment since day one.</p>
        </div>
      </section>
        ...
        <div className="container">
          <div ref={storyRef} className={`about-grid reveal ${storyVis ? 'visible' : ''}`}>
            ...
            <div className="about-text">
              ...
              <h2 className="section-title" style={{ textAlign: 'left' }}>Construction at the Least Margin Possible</h2>
              ...
              <p>Whether you're building your dream home, searching for the perfect commercial space, or sourcing building materials — we handle everything so you can sit back and relax.</p>
            </div>
          </div>
        </div>
      </section>
